...
router.route('/register').post(upload.single('img'), userControllers.createNewUser)
...
router.route('/faves/:id').get(userControllers.findUserFavs).post(userControllers.saveUserFav)

router.route('/update').put(upload.single('img'),userControllers.updateUserDetail)
...
router.route('/chats/:id').post(userControllers.saveChat).get(userControllers.showChats)
